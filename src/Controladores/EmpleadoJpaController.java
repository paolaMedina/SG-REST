...
public class EmpleadoJpaController implements Serializable {
     ...
     private static String secretKey = "claveEncriptar"; //llave para encriptar  y desencriptar contraseña
    ...
    public String desencriptar(String contraseñaEncriptada) throws Exception {

        String base64Encrypted = "";

        try { 
            byte[] message = Base64.decodeBase64(contraseñaEncriptada.getBytes("utf-8"));
            MessageDigest md = MessageDigest.getInstance("MD5");
            byte[] digestOfPassword = md.digest(secretKey.getBytes("utf-8"));
            byte[] keyBytes = Arrays.copyOf(digestOfPassword, 24);
            SecretKey key = new SecretKeySpec(keyBytes, "DESede");
            ...
            base64Encrypted = new String(plainText, "UTF-8");
